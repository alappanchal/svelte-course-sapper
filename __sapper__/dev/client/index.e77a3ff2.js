...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$7, 123, 4, 3362);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-1bgku22");
			add_location(section1, file$7, 127, 4, 3531);
		},
		m: function mount(target, anchor) {
...
// (126:8) <Button on:click="{startAdd}" >
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(126:8) <Button on:click=\\\"{startAdd}\\\" >",
		ctx
	});
...
// (129:8) {#if filteredMeetupsList.length===0}
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$7, 129, 12, 3615);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p, anchor);
			append_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(129:8) {#if filteredMeetupsList.length===0}",
		ctx
	});
...
// (135:8) {#each filteredMeetupsList as meetup (meetup.id) }
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$7, 135, 12, 3901);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(135:8) {#each filteredMeetupsList as meetup (meetup.id) }",
		ctx
	});
