...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$7, 124, 4, 3525);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-1bgku22");
			add_location(section1, file$7, 128, 4, 3694);
		},
		m: function mount(target, anchor) {
...
// (127:8) <Button on:click="{startAdd}" >
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(127:8) <Button on:click=\\\"{startAdd}\\\" >",
		ctx
	});
...
// (130:8) {#if filteredMeetupsList.length===0}
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$7, 130, 12, 3778);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p, anchor);
			append_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(130:8) {#if filteredMeetupsList.length===0}",
		ctx
	});
...
// (136:8) {#each filteredMeetupsList as meetup (meetup.id) }
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$7, 136, 12, 4064);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(136:8) {#each filteredMeetupsList as meetup (meetup.id) }",
		ctx
	});
