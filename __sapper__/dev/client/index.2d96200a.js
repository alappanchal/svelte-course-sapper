...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$7, 121, 4, 3219);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-1bgku22");
			add_location(section1, file$7, 125, 4, 3388);
		},
		m: function mount(target, anchor) {
...
// (124:8) <Button on:click="{startAdd}" >
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(124:8) <Button on:click=\\\"{startAdd}\\\" >",
		ctx
	});
...
// (127:8) {#if filteredMeetupsList.length===0}
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$7, 127, 12, 3472);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p, anchor);
			append_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(127:8) {#if filteredMeetupsList.length===0}",
		ctx
	});
...
// (133:8) {#each filteredMeetupsList as meetup (meetup.id) }
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$7, 133, 12, 3758);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(133:8) {#each filteredMeetupsList as meetup (meetup.id) }",
		ctx
	});
...
function preload(page) {
	...
	return this.fetch("https://svelte-course-20c5e-default-rtdb.firebaseio.com/meetups.json").then(res => {
		...
		isLoading = false;
		console.log(err);
		this.error(500, "Custom Error Mesage - could not fetch meetups data");
	});
}
