...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$7, 137, 4, 4237);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-1bgku22");
			add_location(section1, file$7, 141, 4, 4406);
		},
		m: function mount(target, anchor) {
...
// (140:8) <Button on:click="{startAdd}" >
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(140:8) <Button on:click=\\\"{startAdd}\\\" >",
		ctx
	});
...
// (143:8) {#if filteredMeetupsList.length===0}
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$7, 143, 12, 4490);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p, anchor);
			append_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(143:8) {#if filteredMeetupsList.length===0}",
		ctx
	});
...
// (149:8) {#each filteredMeetupsList as meetup (meetup.id) }
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$7, 149, 12, 4776);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(149:8) {#each filteredMeetupsList as meetup (meetup.id) }",
		ctx
	});
...
function preload(page) {
	...
	function fetchData() {
		return _this.fetch("https://svelte-course-20c5e-default-rtdb.firebaseio.com/meetups.json").then(res => {
			if (!res.ok) {
