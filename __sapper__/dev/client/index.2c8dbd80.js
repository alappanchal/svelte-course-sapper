...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section0, file$7, 131, 4, 3956);
			attr_dev(section1, "id", "meetups");
			attr_dev(section1, "class", "svelte-1bgku22");
			add_location(section1, file$7, 135, 4, 4125);
		},
		m: function mount(target, anchor) {
...
// (134:8) <Button on:click="{startAdd}" >
function create_default_slot$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(134:8) <Button on:click=\\\"{startAdd}\\\" >",
		ctx
	});
...
// (137:8) {#if filteredMeetupsList.length===0}
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$7, 137, 12, 4209);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p, anchor);
			append_dev(p, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(137:8) {#if filteredMeetupsList.length===0}",
		ctx
	});
...
// (143:8) {#each filteredMeetupsList as meetup (meetup.id) }
function create_each_block(key_1, ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$7, 143, 12, 4495);
			this.first = div;
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(143:8) {#each filteredMeetupsList as meetup (meetup.id) }",
		ctx
	});
...
function create_fragment$7(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			const head_nodes = query_selector_all("[data-svelte=\"svelte-1hlgd7e\"]", document.head);
		...
		h: function hydrate() {
			document.title = "All Meetups - With 'Preload' fetching data";
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
function instance$7($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*favOnly, fetchedMeetups*/ 1536) {
			 $$invalidate(2, filteredMeetupsList = favOnly
			? fetchedMeetups.filter(item => item.isFavorite)
			: fetchedMeetups);
		}
	};
